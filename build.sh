...
CLANG_AR="${BUILD_CROSS_COMPILE}ar"
CLANG_CC=$CLANG_BIN_PATH/clang
CLANG_LD=$CLANG_BIN_PATH/ld.lld
CLANG_LDLTO=$CLANG_BIN_PATH/ld.lld
CLANG_NM="${BUILD_CROSS_COMPILE}nm"

GCC_AR="${BUILD_CROSS_COMPILE}gcc-ar"
GCC_CC="${BUILD_CROSS_COMPILE}gcc"
GCC_LD="${BUILD_CROSS_COMPILE}ld"
GCC_LDLTO="${BUILD_CROSS_COMPILE}ld"
GCC_NM="${BUILD_CROSS_COMPILE}gcc-nm"
